...
func (h AuthHooks) CallBeforeLogout(ctx context.Context, sessionID string) error {
...
func (h AuthHooks) CallAfterEmailVerified(ctx context.Context, userID, profileID string, claims map[string]any) error {
...
func (h AuthHooks) CallAfterOAuthLogin(ctx context.Context, userID string, provider string, isNewUser bool) error {
